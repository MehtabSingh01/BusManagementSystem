    ...
    #include <stdlib.h>
    #include <string.h>
    char ch[10][130]={"Delhi-->Chandigarh","Delhi-->Jaipur","Delhi-->Ambala Cantt","Delhi-->Rishikesh","Delhi-->Bahar"};
    char name[32][100]={'\0'};
    char number[32][2]={'\0'};
    int num1[32]={0};
    int trno;
    ...
    printf("   The Total booking amount is %d",200*booking);
          break;
        case 2:
    printf("   The Total booking amount is %d",300*booking);
          break;
        case 3:
    printf("   The Total booking amount is %d",100*booking);
          break;
        case 4:
    printf("   The Total booking amount is %d",400*booking);
          break;
        case 5:
    printf("   The Total booking amount is %d",800*booking);
          break;
    ...
    void cancle()
    {
     ...
     FILE *a,*b;
     printf("\n\n   \xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\n");
     printf("   ENTER THE SEAT NUMBER BOOKED: ");
     scanf("%d",&bookData);
     printf("\n\n   \xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\n");
     for(int r = 0; r<bookData;r++){
      printf("   ENTER THE SEAT NUMBER: ");
      scanf("%d",&seat_no);
     a = fopen(tempstr1,"w+");
     b = fopen(tempstr2,"w+");
    ...
    switch (trno) {
        case 1:
    printf("   Your Rupees has been Returned %d",200*bookData);
          break;
        case 2:
    printf("   Your Rupees has been Returned %d",300*bookData);
          break;
        case 3:
    printf("   Your Rupees has been Returned %d",100*bookData);
          break;
        case 4:
    printf("   Your Rupees has been Returned %d",400*bookData);
          break;
        case 5:
    printf("   Your Rupees has been Returned %d",800*bookData);
          break;
